...
export const DriveFocusApp = () => {
  const { user, isLoading: authLoading, login, signup, logout, isAuthenticated } = useAuth();
  const { currentTrip, trips, stats, startTrip, endTrip, addDistraction } = useTrip();
